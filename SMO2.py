# -*- coding: utf-8 -*-
"""
Created on Wed Jul 22 15:10:40 2020
...
def smoSimple(dataMatIn,classLabels,C,toler,maxIter):
    ...
    return b,alphas
# ————————————————
# 版权声明：本文为CSDN博主「卓寿杰_SoulJoy」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
# 原文链接：https://blog.csdn.net/u011239443/java/article/details/77170119